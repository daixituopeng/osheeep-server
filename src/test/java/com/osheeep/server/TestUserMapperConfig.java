...
public class TestUserMapperConfig {
    ...
    @Bean
    public DinnerHouseholdShoppingItemMapper dinnerHouseholdShoppingItemMapper() {
        return Mockito.mock(DinnerHouseholdShoppingItemMapper.class);
    }
    ...
    @Bean
    public DinnerMenuCookingDishMapper dinnerMenuCookingDishMapper() {
        return Mockito.mock(DinnerMenuCookingDishMapper.class);
    }

    @Bean
    public DinnerNotificationMapper dinnerNotificationMapper() {
        return Mockito.mock(DinnerNotificationMapper.class);
    }

    @Bean
    public DinnerSubscriptionDeliveryMapper dinnerSubscriptionDeliveryMapper() {
        return Mockito.mock(DinnerSubscriptionDeliveryMapper.class);
    }
